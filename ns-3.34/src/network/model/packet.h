...
public:
   ...
   * @author Vinicius - MiM
   * @date Nov 18, 2025
   * @brief Add a packet tag with encryption
   * @param tag the packet tag type to add
   * @param key the encryption key
   * @param nonce the encryption nonce
   */
  void AddPacketTag (const Tag &tag, std::string& key, std::string& nonce) const;
  /**
   ...
   * @author Vinicius - MiM
   * @date Nov 18, 2025
   * @brief Remove a packet tag with encryption
   * @param tag the packet tag type to remove from this packet
   *        The tag parameter is set to the value of the tag found
   * @param key the encryption key
   * @param nonce the encryption nonce
   ...
   *          otherwise.
   */
  bool RemovePacketTag (Tag &tag, std::string& key, std::string& nonce);
  /**
   ...
   * @author Vinicius - MiM
   * @date Nov 18, 2025
   * @brief Replace the value of a packet tag with encryption
   * @param tag the packet tag type to replace.  To get the old
   *        value of the tag, use PeekPacketTag first
   * @param key the encryption key
   * @param nonce the encryption nonce
   ...
   *        either way).
   */
  bool ReplacePacketTag (Tag &tag, std::string& key, std::string& nonce);
  /**
   ...
   * @author Vinicius - MiM
   * @date Nov 18, 2025
   * @brief Search a matching tag with encryption and call Tag::Deserialize if it is found
   * @param tag the tag to search in this packet 
   * @param key the encryption key
   * @param nonce the encryption nonce
   * @returns true if the requested tag is found, false
   *          otherwise
   */
  bool PeekPacketTag (Tag &tag, std::string& key, std::string& nonce) const;
  /**
